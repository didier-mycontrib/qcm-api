...
//SIMPLE VERSION (Standalone JWT or with OAuth2/oidc keycloak server)
...
//tryInitRemoteOAuth2OidcKeycloakMode(); //should be call (if necessary) in server.js
...
export  default {  tryInitRemoteOAuth2OidcKeycloakMode , verifTokenInHeadersForPrivatePath , checkScopeForPrivatePath};
